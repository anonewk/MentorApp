 ...
 */
final class Version20200621171627 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE package_subscription ADD package_id INT NOT NULL');
        $this->addSql('ALTER TABLE package_subscription ADD CONSTRAINT FK_7DA7BA4F44CABFF FOREIGN KEY (package_id) REFERENCES package (id)');
        $this->addSql('CREATE INDEX IDX_7DA7BA4F44CABFF ON package_subscription (package_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE package_subscription DROP FOREIGN KEY FK_7DA7BA4F44CABFF');
        $this->addSql('DROP INDEX IDX_7DA7BA4F44CABFF ON package_subscription');
        $this->addSql('ALTER TABLE package_subscription DROP package_id');
